...
$bdd = new database();
$numberOfStudents = $bdd->getNumberOfStudents();
$numberOfCourses = $bdd->getNumberOfCourses();
$numberOfFormers = $bdd->getNumberOfFormers();
?>
    <div id="wrapper">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div class="huge"><?php echo $numberOfCourses[0]['nb']; ?></div>
                                </div>
                            </div>
                        </div>
                        <a href="lesson.php">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div class="huge"><?php echo $numberOfStudents[0]['nb']; ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div class="huge"><?php echo $numberOfFormers[0]['nb']; ?></div>
                                    </div>
                                </div>
                            </div>
