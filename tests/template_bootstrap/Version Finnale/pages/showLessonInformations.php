                        ...
                        <form class="form-horizontal" action="requestDatabase.php?type=updateLesson&amp;id=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input id="cou_presenceRemplie" name="cou_presenceRemplie" <?php if($cou_presenceRemplie != ""){echo 'checked';}?> type="checkbox" value="<?php echo $cou_presenceRemplie?>" > ok
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="cou_attestationTransmise">Attestation Transmise</label>
                                    <div class="col-md-5">
                                        <input id="cou_attestationTransmise" name="cou_attestationTransmise" <?php if($cou_attestationTransmise != ""){echo 'checked';}?> placeholder="500"  type="checkbox" value="<?php echo $cou_attestationTransmise?>"> ok
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            foreach($database->getAllStudentsInThisLesson($_GET['id']) as $student){
                                ...
                                echo '<td><a href="deleteInLesson.php?el='.$idEleve.'&amp;co='.$_GET['id'].'"><button type="button" value="'.$idEleve.'" class="btn btn-danger">Enlever</button></a></td>';
                                echo '</tr>';
                            }
                            ?>
                            </tbody>
